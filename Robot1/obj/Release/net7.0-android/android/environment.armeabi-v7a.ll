...
@__DSOCacheEntry_name.11 = internal constant [21 x i8] c"libaot-Robot1.dll.so\00", align 1
...
@__DSOCacheEntry_name.48 = internal constant [33 x i8] c"libaot-System.Net.Sockets.dll.so\00", align 1
...
@dso_cache = local_unnamed_addr global [470 x %struct.DSOCacheEntry] [
	...
	; 11
	%struct.DSOCacheEntry {
		i64 158461813, ; hash 0x971ef75, from name: libaot-Robot1.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__DSOCacheEntry_name.11, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 12
	%struct.DSOCacheEntry {
	...
	; 35
	%struct.DSOCacheEntry {
		i64 343099711, ; hash 0x1473493f, from name: aot-Robot1
		i8 0, ; ignore
		i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__DSOCacheEntry_name.11, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 165
	%struct.DSOCacheEntry {
		i64 1626355798, ; hash 0x60f03856, from name: Robot1
		i8 0, ; ignore
		i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__DSOCacheEntry_name.11, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 224
	%struct.DSOCacheEntry {
		i64 2124271981, ; hash 0x7e9dd16d, from name: aot-Robot1.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__DSOCacheEntry_name.11, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 298
	%struct.DSOCacheEntry {
		i64 2718605667, ; hash 0xa20aa163, from name: libaot-Robot1
		i8 0, ; ignore
		i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__DSOCacheEntry_name.11, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 387
	%struct.DSOCacheEntry {
		i64 3468494721, ; hash 0xcebd0781, from name: Robot1.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__DSOCacheEntry_name.11, i32 0, i32 0), ; name
		i8* null; handle
	}, 
