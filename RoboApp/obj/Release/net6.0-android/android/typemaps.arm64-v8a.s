...
map_modules:
	...
	.byte	0x95, 0x4e, 0x2e, 0xdc, 0xbc, 0xb6, 0x6f, 0x42, 0x85, 0x89, 0x87, 0xd9, 0x29, 0x11, 0x16, 0xb1	// module_uuid: dc2e4e95-b6bc-426f-8589-87d9291116b1
	.word	0x2	// entry_count
	.word	0x0	// duplicate_count
	.xword	.L.module16_managed_to_java	// map
	.xword	0	// duplicate_map
	.xword	map_aname.16	// assembly_name: RoboApp
	.xword	0x0	// image
	.word	0x0	// java_name_width
	.zero	4
	.xword	0x0	// java_map
...
map_java:
	...
	.word	0x200000c	// type_token_id
	.ascii	"crc641864db26795f0530/MainActivity"	// java_name
	.zero	69	// byteCount == 34; fixedWidth == 103; returned size == 103
	.zero	1

	.word	0x10	// module_index
	.word	0x200000d	// type_token_id
	.ascii	"crc641864db26795f0530/MainApplication"	// java_name
	.zero	66	// byteCount == 37; fixedWidth == 103; returned size == 103
	.zero	1
